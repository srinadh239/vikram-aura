...
const ReviewCard: React.FC<ReviewCardProps> = ({ text, author }) => {
  return (
    <article className="relative flex flex-col grow px-11 ml-4 pt-40 pb-20 w-full h-[500px] text-2xl font-bold bg-white rounded-2xl border border-solid border-neutral-200 shadow-[0px_0px_50px_rgba(242,101,34,0.2)] text-zinc-600 max-md:px-5 max-md:pt-24 max-md:mt-10 max-md:max-w-full">
      <img
